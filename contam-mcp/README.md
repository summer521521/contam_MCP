# CONTAM Plugin MCP Developer Guide
...
The public `npx` entry point is defined by the repository root `package.json` and `bin/contam-mcp.js`. This subdirectory remains the main source and test area for the MCP server implementation itself.
